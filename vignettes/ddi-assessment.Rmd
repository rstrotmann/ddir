...
The function `perpetrator()` can be used to create custom perpetrator objects:
...
The relevant perpetrator concentrations for a perpetrator compound
...
```{r results="asis"}
print(transporter_inh_risk(examplinib, examplinib_transporter_inhibition))
```
