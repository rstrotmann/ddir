...
The text data contained in chunks of the type 'data' is assigned as-is to a
character variable by the name defined by 'output.var' in the chunk header when
...
Like in the above example, the content of this variable can then be read into a
perpetrator object:
