...
#'
#' This function creates a perpetrator object from key compound data.
#'
...
#'
#' @examples
#' perpetrator("test", 100, 1000, 500, source = c(mw = "study 002"))
...
#' Alternative perpetrator object constructor
#'
#' @description
#' `r lifecycle::badge("deprecated")`
#'
#' @inheritParams perpetrator
#'
#' @returns A perpetrator object.
#' @export
make_perpetrator <- function(
    name, dose, imaxss, mw, type = "parent",
    oral = TRUE, fu = 1, fumic = 1, rb = 1, fa = 1,
    fg = 1, ka = 0.1, solubility = Inf, source = character(0)) {
  lifecycle::deprecate_warn("0.16.1", "make_perpetroator()", "perpetrator()")
  perpetrator(
    name = name, dose = dose, imaxss = imaxss, mw = mw, oral = oral,
