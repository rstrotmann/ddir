...
transporter_ic50 <- load_dmpk_data("/Users/rainerstrotmann/Documents/Programming/R/ddir/tests/testthat/fixtures/transporter-inhibition.R")
...
```{r}
transporter_inhibition_risk_table(p, transporter_ic50)
transporter_inhibition_risk_table(m, transporter_ic50)
```
