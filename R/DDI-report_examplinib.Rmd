...
# compounds <- read_string_perpetrators(compounds_text)
cyp_inhibition_data <- read_dmpk(textConnection(cyp_inhibition_text))
# cyp_inhibition_data <- read_string_dmpk_data(cyp_inhibition_text)
cyp_induction_data <- read_string_cyp_inducer_data(cyp_induction_text)
ugt_inhibition_data <- read_dmpk(textConnection(ugt_inhibition_text))
transporter_inhibition_data <- read_string_dmpk_data(transporter_inhibiton_text)
```
