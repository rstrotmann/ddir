...
```{r results="asis"}
conc_table(compounds, show_dose = TRUE)
```
...
```{r results="asis"}
basic_cyp_inhibition_risk_table(compounds, cyp_inhibition_data, show_dose = TRUE)
```
...
```{r results="asis"}
basic_cyp_tdi_risk_table(compounds, cyp_tdi_data, na.rm=T, show_dose = TRUE)
```
...
```{r results="asis"}
kinetic_cyp_induction_risk_table(compounds, cyp_induction_data, na.rm=T, show_dose = TRUE)
```
...
mech_stat_cyp_risk_table(compounds, cyp_inhibition_data, cyp_induction_data,
                         cyp_tdi_data, include_induction=F, show_dose = TRUE)
```
...
```{r results="asis"}
mech_stat_cyp_risk_table(compounds, cyp_inhibition_data, cyp_induction_data,
                         cyp_tdi_data, include_induction=T, na.rm=T, show_dose=T)
```
