...
cyp_inhibition_data <- read_dmpk_data(textConnection(cyp_inhibition_text))
cyp_induction_data <- read_cyp_inducer_data(textConnection(cyp_induction_text))
ugt_inhibition_data <- read_dmpk_data(textConnection(ugt_inhibition_text))
transporter_inhibition_data <- read_dmpk_data(textConnection(transporter_inhibiton_text))
```
